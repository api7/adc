...
export declare const cleanup: (backend: BackendAPISIX) => Promise<ADCSDK.BackendSyncResult[]>;
...
export declare const sortResult: <T extends Record<string, any>>(result: Array<T>, field: string) => T[];
